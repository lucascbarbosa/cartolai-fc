...
def fetch__pontuacao_atletas__rodada(atleta_id: int, atleta_status: str) -> pd.DataFrame:
    ...
    try:
        ...
        pontuacoes_df[
            'pontos_mean'
        ] = pontuacoes_df['pontos'].shift(1).expanding().mean()
        pontuacoes_df[
            'mpv_mean'
        ] = pontuacoes_df['mpv'].expanding().mean()
        pontuacoes_df[
            'preco_mean'
        ] = pontuacoes_df['preco'].expanding().mean()
        ...
        for col in scout_cols:
            pontuacoes_df[
                f'{col}_mean'
            ] = pontuacoes_df[col].shift(1).expanding().mean()

        return pontuacoes_df.drop(scout_cols, axis=1)
...
auth_header = {
    "Authorization":
    "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6Ijg5NWIwYmIwLTI4ODMtNDE3MC1hMDY2LTZkMDIwZjkzNGRlMyIsInR5cCI6IkpXVCJ9..e00AKjj29mViJ5J5SutWDQVFY45bHJjKZKv_XJUOi8nSL87fWZzjlb0ZHaYLHItey5xP4OwYlVB_DqbLRLNmvyMvVJ3azchsnWdsb86ZIsdZzlXapVl6SmD6H7n4d9SbP0THkRBprolpqeftgSCJkzGyT3XCqwP_mySDHauGsHlduxj6Cwj6W6NQlXc6wgw78OqLDuvFEJMoO6XNATUhCog0qT1AcaN8IsKyhsRm571879kV1zoN57yJFlRm8S0HDd6LKfWPMyPUHIrdf1xR4TSx4gh3rny2mssXX-IhYApSAyYra0iDs8cSZGBN_yGcR-6RuxiOhydGcqCfzz6p2Q"
}
